...
import { TwoCol, Stack } from '../primitives/Layout.jsx';
...
export function LedgerDetail({
  game, revenue, spending, balance, balanceDiff, deficitGDP, debtRatio, committed,
  onClose,
}) {
  const revenueRows = [
  ...
  return (
    <Modal tone="neutral" size="wide" onClose={onClose} showCloseButton className="relative">
      <div className="mb-4 pr-6">
        <Card.Eyebrow>Full Ledger</Card.Eyebrow>
        <h2 className="font-display text-xl md:text-2xl font-medium italic text-stone-100 mt-1">
          Revenue &amp; Spending
        </h2>
        <p className="text-[12px] text-stone-500 mt-1">Annualised. Revenue scales with nominal GDP.</p>
      </div>
      <Stack gap="md">
        <TwoCol
          ratio="even"
